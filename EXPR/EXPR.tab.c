...
#line 134 "EXPR.tab.c" /* yacc.c:355  */
};
...
{
  "$end", "error", "$undefined", "PRINT", "SEMICOLON", "PLUS", "MINUS",
  "MULT", "ASSIGN", "OPAR", "CPAR", "ID", "NUM", "UMINUS", "$accept",
  "instrlist", "instr", "expr", YY_NULLPTR
};
#endif
...
{
       0,    -4,    -6,    13,    10,   -10,     6,   -10,     0,     6,
       6,   -10,   -10,    -1,   -10,   -10,    14,     6,     6,     6,
     -10,     9,     9,   -10
};
...
{
      15,    16,     6,     1,    17,    18,    19,     5,    21,    22,
      23,     2,     9,     7,     8,    10,    19,    11,    12,    17,
      18,    19,     0,    14,    20
};

static const yytype_int8 yycheck[] =
{
       9,    10,     8,     3,     5,     6,     7,    11,    17,    18,
      19,    11,     6,     0,     4,     9,     7,    11,    12,     5,
       6,     7,    -1,     8,    10
};
...
{
       0,     3,    11,    15,    16,    11,     8,     0,     4,     6,
       9,    11,    12,    17,    15,    17,    17,     5,     6,     7,
      10,    17,    17,    17
};
...
#line 40 "EXPR.y" /* yacc.c:1646  */
    {    
    struct symbol * id = symtable_get(SYMTAB,(yyvsp[-2].strval));
    if ( id == NULL )
        id = symtable_put(SYMTAB,(yyvsp[-2].strval));
    gencode(CODE,COPY,id,(yyvsp[0].exprval).ptr,NULL);
  }
#line 1237 "EXPR.tab.c" /* yacc.c:1646  */
    break;
...
#line 1287 "EXPR.tab.c" /* yacc.c:1646  */
    break;
...
#line 1309 "EXPR.tab.c" /* yacc.c:1646  */
    break;
...
#line 1321 "EXPR.tab.c" /* yacc.c:1646  */
      default: break;
    }
